...
export default function Trending({logo,coin,shortname,trend,price,trendVisual}) {
  ...
  return (
    <div className="bg-black w-full rounded-2xl flex flex-col justify-between items-center gap-4 p-2">
      <div className="flex justify-between items-center gap-5 w-full">
        ...
        <div className="flex flex-col justify-center items-start gap-2">
          <span className="font-mono text-xs text-white font-semibold capitalize">{coin}</span>
          <span className="text-[10px] uppercase text-primary-gray font-mono">{shortname}</span>
        </div>
